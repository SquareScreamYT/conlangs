...
Nimine has 3 different orthographies: Logography, Latin and Cyrillic. This document will be written in the Latin version.
...
/ç/ is represented by using Х followed by Я, Йи, Ю, Є or Ё.
...
* The letter "n" is written as "ń" in Latin orthography and "Ӈ/ӈ" in Cyrillic orthography before [k] or [g] and is pronounced as [ŋ].
* The letter "n" is written as "m" in Latin orthography and "М/м" in Cyrillic orthography before [p] or [b] and is pronounced as [m].
